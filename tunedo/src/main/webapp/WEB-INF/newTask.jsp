...
<body class="content bg-gray-50">
    ...
    <main>
        <div class="flex justify-center min-h-full bg-white border-gray-200 dark:bg-gray-900 py-16 relative overflow-hidden">
            <form:form action="new" method="POST" id="task-form" class="flex flex-col max-w-max mx-5 bg-white p-8 rounded-3xl shadow-md w-full space-y-4" modelAttribute="task">
            <div class="relative">
