...
<body>
    <div class="d-flex flex-column justify-content-around my-3 m-auto w-75">
        <h1 class="my-3">Editando una tarea</h1>
        <div>
        ...
        <div class="form-row d-flex justify-content-between w-50 my-3">
            ...
            <form:input type="text" path="title" value="${task.getTitle()}"/>
        </div>
        ...
        <div class="form-row d-flex justify-content-between w-50 my-3">
            ...
            <form:textarea class="w-50 h-lg" type="textarea" path="description" value="${task.getDescription()}"/>
        </div>
            <form:errors class="alert alert-danger form-text text-muted" path="description" />


        <div class="form-row d-flex justify-content-between w-50 my-3">
            <form:label path="notes">Notas adicionales: (opcional) </form:label>
            <form:textarea class="w-50 h-lg" type="textarea" path="notes"/>
        </div>
            <form:errors class="alert alert-danger form-text text-muted" value="${task.getNotes()}" path="notes" />
